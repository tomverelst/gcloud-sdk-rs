...
pub struct StepEntry {
    ...
    pub exception: Option<Box<models::Exception>>,
    ...
    pub navigation_info: Option<Box<models::NavigationInfo>>,
    ...
    pub step_entry_metadata: Option<Box<models::StepEntryMetadata>>,
